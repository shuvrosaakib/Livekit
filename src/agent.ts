...
import type { TutorSessionConfig, TutorMode, CEFRLevel } from '../shared/types.js';
...
export function buildInstructions(config: TutorSessionConfig): string {
...
export function createAgent(config: TutorSessionConfig) {
  return new voice.Agent({
    instructions: buildInstructions(config),
  });
}

export function createGeminiRealtimeModel(config: TutorSessionConfig) {
